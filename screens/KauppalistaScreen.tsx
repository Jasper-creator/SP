...
export default function KauppalistaScreen({ onBack }: Props) {
  ...
  if (otherItems.length > 0)
    grouped.push({ category: 'Muut', items: otherItems });
      ...
      <View style={styles.header}>
        ...
        <View style={styles.statsRow}>
          <Text style={styles.statsText}>
            {remaining} ostettavaa
            {doneCount > 0 ? ` · ${doneCount} ostettu` : ''}
          </Text>
          {doneCount > 0 && (
                    ...
                    <View style={styles.itemMeta}>
                      ...
                      <View style={styles.itemByRow}>
                        <Text style={styles.itemBy}>
                          {item.addedBy === 'jasper' ? 'Jasper' : 'Senja'}
                        </Text>
                      </View>
                    </View>
                  </View>
                    ...
                    {UNITS.map(u => (
                      ...
                      >
                        <Text
                          style={[
                            styles.unitText,
                            newUnit === u && styles.chipTextActive,
                          ]}
                        >
                          {u}
                        </Text>
...
const styles = StyleSheet.create({
  ...
  clearText: { color: 'rgba(0,0,0,0.36)', fontSize: 13, fontWeight: '600' },
  ...
  itemBy: { fontSize: 12, color: 'rgba(0,0,0,0.36)' },
  removeBtn: { padding: 6 },

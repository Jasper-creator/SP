...
export default function KohdelistaScreen({ onBack }: Props) {
  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.subtitle}>{items.length} kohdetta listalla</Text>
      </View>
          ...
          >
            ...
            >
              <TouchableOpacity activeOpacity={1} style={styles.sheet}>
                ...
                <Text style={styles.fieldLabel}>Paikan nimi *</Text>
                <TextInput
                  style={styles.input}
